...
public abstract class BaseTokenizer extends Tokenizer {
    ...
    protected BaseTokenizer(TokenizerConfig options) {
     ...
     */
    public static Reader jasoDecompose(Reader in, TokenizerConfig options) {
        Writer writer = new StringWriter();
        JasoDecomposition decomposer = new JasoDecomposition();
        ...
        try {
            ...
            temp = decomposer.runJasoDecomposition(temp, options);
